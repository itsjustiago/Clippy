...
// Brand coral, top→bottom gradient.
let top = NSColor(srgbRed: 1.00, green: 0.46, blue: 0.44, alpha: 1)   // #FF7570
let bottom = NSColor(srgbRed: 0.96, green: 0.28, blue: 0.31, alpha: 1) // #F5484F
...
func makeIcon(_ px: Int) -> Data {
    ...
    // White clipboard glyph, centered, with a soft shadow.
